			...
			<div className=''>
				<div className='relative h-screen'>
					...
					<div className='relative z-10 flex flex-col items-center justify-center h-full'>
						...
						<div
							className='mt-15 h-1 bg-orange-300/50 md:mt-20 mt-13 h-2 w-50 
						2xl:w-80 2xl:h-3'
						></div>
					</div>
				</div>
							...
							<div className='flex justify-center group'>
								<div className='duration-800 group/main '>
									{home.map(link => (
										...
										>
											<section
												className='uppercase flex justify-center duration-700 font-bold border-2 border-black/80 text-base rounded-lg p-2 text-white text-center bg-yellow-900/90 
