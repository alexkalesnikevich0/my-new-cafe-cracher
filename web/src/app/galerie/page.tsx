		...
		<div className='bg-orange-300/80'>
			<div className='relative h-screen'>
				...
				<div className='relative z-10 flex flex-col items-center justify-center h-full'>
					...
					<h2 className='uppercase text-4xl text-center font-bold text-white/90 mb-7 sm:text-4xl md:text-5xl lg:text-5xl xl:text-7xl 2xl:text-7xl 2xl:mb-9'>
						Eindrücke <br />
						aus dem Brauhaus
					</h2>
					<div className=''>
												...
												<div key={link.route} className=''>
													<Link href={`${link.route}`} className=''>
														<figcaption className='border-2 pl-2 pr-2 p-1 flex items-center gap-2 mt-4 mb-4 md:mb-0'>
															MEHR
															<figure className='rounded-full duration-600 w-8 group-hover/lol:w-11 flex h-1 bg-black/90 md:bg-black/50 md:group-hover/lol:bg-black md:w-9 md:group-hover/lol:w-11 xl:w-9 xl:group-hover/lol:w-11 2xl:w-11 2xl:group-hover/lol:w-13'></figure>
														</figcaption>
													</Link>
												</div>
											))}
				...
				<div className='justify-center items-center flex-col flex'>
					<div className='mt-15 justify-center lg:flex lg:hidden:items-center lg:hidden:flex-col lg:hidden:justify-center lg:hidden:flex lg:columns-2 lg:gap-8 xl:gap-15'>
						<section className='group duration-900 md:flex md:hover:border-3 md:hover:border-black xl:mr-0'>
							...
							<div className='group duration-900 justify-center flex md:w-[43%]'>
								<div className='group duration-900 md:py-10'>
									<h1 className='duration-900 text-center mt-3 md:mt-0 md:group-hover:text-2xl xl:group-hover:text-3xl 2xl:group-hover:text-4xl 2xl:group-hover:mt-15'>
										HIER WIRD <br />
										DER NUBBEL <br />
										VERBANNT
									</h1>
