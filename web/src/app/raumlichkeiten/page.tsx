					...
					<section className=''>
						...
						<div className='w-[100%] md:w-[50%]'>
							...
							<h2 className='text-center pl-5 pr-5 mb-5 mt-5 md:pl-8 md:pr-11 md:text-left xl:mb-4 2xl:mt-12'>
								...
								was zu einem frisch gezapften, gepflegten Sion Kölsch vom Fass
								passt. Ein absoluter Hingucker ist natürlich die Aufzuganlage,
								durch die unsere eiskalten Fässer den Weg aus dem Keller auf die
								Theke finden.
								<br />
							</h2>
						</div>
					...
					<section className=' '>
						<div className='w-[100%] md:w-[50%]'>
							...
							<h2 className='text-center text-center mt-5 pr-8 pl-11 lg:text-right 2xl:mt-10'>
								...
								Nukleus der Marke. Sitzend finden hier rund 200 Personen Platz.
							</h2>
					...
					<section className=' '>
						<div className='w-[100%] md:w-[50%]'>
							...
							<h2 className='text-center text-center pr-8 pl-11 mt-2 lg:text-right lg:mt-5 2xl:mt-10'>
								Die Hans Sion-Stube bietet Platz für ungefähr 25 Personen. Diese
								Stube eignet sich jedoch auch hervorragend für Gesellschaften
								von maximal 16 Personen, die dann gemeinsam an einer großen
				...
				<div className='flex justify-center mt-10'>
					<section className=' '>
						<div className='w-[100%] md:w-[50%]'>
							...
							<h2 className='text-center text-center mt-5 pr-8 pl-11 lg:text-right 2xl:mt-10'>
								Dieser Raum bietet Platz für ca. 50 Personen, grenzt aber an den
								Hopfengarten an und kann daher auch erweitert werden. Hier wird
								das Thema Kölner Dreigestirn inszeniert – oder sagen wir:
								„zelebriert“.
							</h2>
					...
					<section className=''>
						...
						<div className='w-[100%] md:w-[50%]'>
							...
							<h2 className='pl-5 pr-5 mb-4 mt-5 text-center md:text-left text-md md:pl-8 md:pr-11 xl:mb-4 2xl:mt-12'>
								Hier trifft man sich, um in kneipenähnlicher Atmosphäre leckeres
								Sion Kölsch zu genießen. Die Stube bietet ca.
							</h2>
				...
				<div className='flex justify-center mt-10'>
					<section className=' '>
						<div className='w-[100%] md:w-[50%]'>
							...
							<h2 className='text-center text-center mt-5 pr-8 pl-11 lg:text-right 2xl:mt-10'>
								In unserem Hopfengarten finden rund 36 Personen Platz. In diesem
								überdachten Freibereich kann man ganzjährig
					...
					<article className='w-[90%] sm:w-[75%] md:hidden:flex-col md:flex md:w-[80%] 2xl:w-350 2xl:h-120 '>
						<div className='w-[100%] md:w-[50%]'>
							...
							<h2 className='mb-15 text-center text-lg text-center mt-5 pr-8 pl-11 sm:text-xl 2xl:text-xl 2xl:mt-7'>
								Entdecken Sie unser Brauhaus in unserem 360° Rundgang und machen
								Sie sich einen originalgetreuen Eindruck unserer Räumlichkeiten.
							</h2>
						</div>
						<div className='w-[100%] md:w-[50%]'>
							<img
