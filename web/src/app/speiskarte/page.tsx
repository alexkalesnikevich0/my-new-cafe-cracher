          ...
          md:[&_h4]:text-xl md:[&_h5]:text-base md:[&_h6]:text-lg 
				...
				>
					<div className='flex w-full justify-between px-5'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>7,30 €</h6>
					</div>
					...
					<div className='flex w-full justify-between px-5'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>5,20 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>9,50 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>6,80 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
					...
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
							...
							<h5 className=''>mit Sauce Hollandaise und Butter Kartoffeln</h5>
						</div>
						<h6 className='flex-shrink-0 flex ml-auto items-center'>20,90 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
							<h4 className=''>Portion Stürzelsberger Spargel</h4>
							<h5 className=''>
								mit Sauce Hollandaise, gekochtem Schinken und Butter-Kartoffeln
							</h5>
						</div>
						<h6 className='flex-shrink-0 flex ml-auto items-center'>25,90 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
							<h4 className=''>Portion Stürzelsberger Spargel</h4>
							<h5 className=''>
								mit Sauce Hollandaise, zwei Wiener Schnitzel & Butter-Kartoffeln
							</h5>
						</div>
						<h6 className='flex-shrink-0 flex ml-auto items-center'>26,90 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>32,50 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>36,50 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>17,40 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>22,30 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>23,30 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					...
					<div className='flex w-full justify-between px-5'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>15,80 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>6,40 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>17,80 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					...
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
							...
							<h5 className=''>
								mit Gerstenmalz gebacken, Crème fraîche Schwarzwälder Schinken,
								Lauch und Zwiebeln
							</h5>
						</div>
						<h6 className='flex-shrink-0 flex ml-auto items-center'>16,80 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
					...
					<div className='flex w-full justify-between px-5'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>7,80 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>8,60 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>7,90 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>14,30 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='sm:flex sm:justify-center sm:pt-10 sm:pb-0 md:p-10 lg:p-5 md:w-[100%] lg:items-center lg:pr-0'>
						<img
					...
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
							...
							<h5 className=''>
								gebratene Blutwurst mit Schmorzwiebeln auf Kartoffelpüree, dazu
								Apfelkompott
							</h5>
						</div>
						<h6 className='flex-shrink-0 flex ml-auto items-center'>15,80 €</h6>
					...
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
							...
							<h5 className=''>
								Roastbeef, kalt, rosa gebraten, mit Bratkartoffeln und Remoulade
							</h5>
						</div>
						<h6 className='flex-shrink-0 flex ml-auto items-center'>22,40 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>13,80 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>19,40 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>23,80 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
					...
					<div className='flex w-full justify-between px-5'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>18,40 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>16,70 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>24,30 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
					...
					<div className='flex w-full justify-between px-5'>
						...
						<h6 className='flex-shrink-0 flex ml-auto items-center'>20,40 €</h6>
					</div>
					<h1 className='rounded-full h-1'></h1>
					<div className='flex w-full justify-between px-5'>
						<div className='flex-col justify-start items-center'>
							<h4 className=''>Schnitzel</h4>
							<h5 className=''>mit einer pikanten Sauce und Bratkartoffeln</h5>
						</div>
						<h6 className='flex-shrink-0 flex ml-auto items-center'>20,40 €</h6>
					</div>
