		...
		<div className=''>
			<div className='font-bold sm:inline-block'>
				...
				<div className='sm:inline-block'>
					<button
						className='ml-7 mt-7 sm:border-white bg-gray-200 sm:bg-white border-blue-600 rounded-sm border-2 hover:border-blue-600 hover:rounded-sm px-2 
					h-8 inline-block hover:bg-gray-200 sm:ml-110 mt-0 sm:mt-0 mr-40 sm:mr-0'
						onClick={() => {
							setOpenModal(true)
						}}
					>
