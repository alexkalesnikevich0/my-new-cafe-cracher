		...
		<div className='xl:h-240 2xl:h-340'>
			<div className='mt-30'>
				<div className='justify-center items-center flex-col flex'>
					<div
						className='w-85 h-150 group border-2 border-black/70 duration-900 rounded-2xl bg-white/70 hover:bg-white/80 
					...
					>
						<div className='group'>
							<img
								className='w-71 h-70 ml-7 mr-2 mt-4 border-2 rounded-xl duration-900 border-black/70 
						...
						<div className='group duration-700'>
							<div
								className='ml-18 pl-2 mt-9 font-black text-blue-950/90 text-xl duration-900 
				...
				<div className='justify-center items-center flex-col flex md:justify-center'>
					<div
						className='w-85 h-150 duration-900 mt-10 group border-2 border-black/70 rounded-2xl bg-white/70 hover:bg-white/80 
					...
					>
						<div className='group'>
							<img
								className='w-71 h-70 ml-7 mt-7 rounded-xl border-2 border-black/70 duration-900 
						...
						<div className='group duration-700 md:ml-3 md:group-hover:ml-7 lg:ml-8 lg:group-hover:ml-10 2xl:ml-10 2xl:mt-12'>
							...
							>
								...
								<div className='duration-900 font-bold text-white text-black/80 text-lg mt-3 flex md:group-hover:font-extrabold'>
									<div
										className='ml-23 duration-900 w-37 h-1 bg-black/50 mt-3 rounded-xl 
				...
				<div className='justify-center items-center flex-col flex mb-7'>
					<div
						className='w-85 h-150 mt-10 group border-2 border-black/70 rounded-2xl duration-900 bg-white/70 hover:bg-white/80 hover:border-black
					...
					>
						<div className='group'>
							<img
								className='w-71 h-70 ml-6 mt-7 border-2 border-black/70 rounded-xl duration-900 
						...
						<div className='group duration-900'>
							<div
								className='text-2xl ml-10 mt-12 font-black text-blue-950/90 duration-900 
