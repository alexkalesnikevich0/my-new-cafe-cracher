			...
			<div className='mt-10 md:flex md:w-full'>
				<div className='md:w-[50%] lg:w-[60%] xl:w-[50%] 2xl:w-[60%]'>
					<div className='justify-center flex'>
						<h1
							className='w-90 h-50 text-lg font-black text-center 
						sm:text-lg 
						md:text-md md:mt-10 md:ml-10 md:h-43 md:w-250 
						lg:h-30 lg:ml-15 lg:text-xl 
					...
					<div className='flex justify-center h-15 md:h-20 md:mt-3'>
						{image.map(link => (
							<Link href={`${link.route}`} key={link.route}>
								<section
									className='p-4 mt-2 text-blue-700/90 font-extrabold duration-500 text-lg 
								hover:text-lg hover:text-blue-700 hover:font-black hover:text-2xl 
								sm:text-xl sm:hover:text-2xl sm:hover:mt-1 
								md:ml-9 
				...
				<div className='md:w-[50%] md:h-60 lg:w-[40%] lg:h-80 xl:w-[50%] 2xl:w-[40%]'>
					<div className='mt-8 md:mt-15 2xl:mt-17'>
						{image.map(link => (
							<Link href={`${link.route}`} key={link.route}>
								<div
									className='group h-15 w-70 border-black border-1 text-lg items-center mx-auto justify-center bg-yellow-900/90 flex rounded-sm duration-600 hover:bg-white 
						md:w-82 md:hover:w-88 md:hover:ml-5 md:ml-8 md:h-14 md:hover:h-15 md:hover:mt-2 md:hover:text-xl 
						lg:ml-7 lg:hover:ml-6 lg:hover:h-14 lg:hover:w-94 lg:w-92 lg:hover:h-18 lg:h-16 lg:hover:text-2xl 
						xl:ml-55 xl:hover:h-16 xl:hover:ml-54 
						2xl:ml-15 2xl:hover:ml-13 2xl:hover:h-19 2xl:hover:w-135 2xl:w-130 2xl:h-19'
								>
									<div className='text-center text-white font-extrabold mb-2 mt-2'>
										<div className='group'>
											<section
												className='duration-500 flex font-bold text-white text-md group-hover:text-yellow-800/90 
					...
					<div className='mt-5 pb-20 md:mb-30'>
						{image.map(link => (
							<Link href={`${link.route}`} key={link.route}>
								<div
									className='pr-5 group w-70 h-20 border-black border-1 items-center bg-yellow-900/90 flex duration-600 rounded-sm justify-center hover:bg-white 
						md:ml-8 md:pr-0 md:hover:h-17 md:hover:w-88 md:w-82 md:hover:ml-5 md:hover:h-12 md:h-17 md:hover:mt-2 
						lg:ml-7 lg:hover:ml-6 lg:w-92 lg:hover:w-94 
						xl:ml-55 xl:hover:ml-54 
						2xl:ml-15 2xl:hover:ml-13 2xl:hover:h-22 2xl:hover:border-1 2xl:hover:w-135 2xl:w-130 2xl:h-22'
								>
									<div className='text-center text-white font-extrabold mb-3 mt-2'>
										<div className='group'>
											<section
												className='text-sm duration-500 font-bold text-white flex text-center items-center justify-center group-hover:text-yellow-800/90 
											md:group-hover:text-md md:text-md 
											xl:group-hover:font-extrabold 
											...
											>
												...
												<div
													className='ml-2 duration-500 w-15 h-1 bg-black/40 rounded-full group-hover:bg-black/80
